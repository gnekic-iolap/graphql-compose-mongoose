...
describe('DiscriminatorTypeComposer', () => {
  ...
  describe('class methods', () => {
    ...
    describe('addNestedFields(newFields)', () => {
      ...
      it('should add field to baseTC', () => {
        expect(characterDTC.getFieldTC('field1').getFieldType('nested')).toEqual(_graphqlCompose.graphql.GraphQLString);
      });
      it('should add field to DInterface', () => {
        expect(characterDTC.getDInterface().getFieldTC('field1').getFieldType('nested')).toEqual(_graphqlCompose.graphql.GraphQLString);
      });
      it('should have exactly plus two fields added to childTC fields', () => {
        expect(droidTC.getFieldTC('field1').getFieldType('nested')).toEqual(_graphqlCompose.graphql.GraphQLString);
        expect(personTC.getFieldTC('field2').getFieldType('nested')).toEqual(_graphqlCompose.graphql.GraphQLString);
      });
  ...
  describe('discriminator()', () => {
    ...
    it('should return an instance of TypeComposer as childTC', () => {
      expect(characterDTC.discriminator(PersonModel)).toBeInstanceOf(_graphqlCompose.TypeComposer);
      expect(characterDTC.discriminator(DroidModel)).toBeInstanceOf(_graphqlCompose.TypeComposer);
    });
