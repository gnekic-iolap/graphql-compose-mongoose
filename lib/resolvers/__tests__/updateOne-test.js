...
describe('updateOne() ->', () => {
  ...
  describe('Resolver.resolve():Promise', () => {
    ...
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      const result = yield (0, _updateOne.default)(_userModel.UserModel, UserTC).resolve({
        args: {
          filter: {
            _id: user1.id
          }
    ...
    _asyncToGenerator(function* () {
      ...
      yield (0, _updateOne.default)(_userModel.UserModel, UserTC).resolve({
        args: {
          filter: {
            _id: user1.id
          },
    ...
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      const result1 = yield (0, _updateOne.default)(_userModel.UserModel, UserTC).resolve({
        args: {
          filter: {
            relocation: true
          },
      ...
      const result2 = yield (0, _updateOne.default)(_userModel.UserModel, UserTC).resolve({
        args: {
          filter: {
            relocation: true
          },
